...
if __name__ == '__main__':
    ...
    # period = 1000 nm
    df_sample["特征频率 (THz)"] = df_sample["特征频率 (THz)"].apply(convert_complex).apply(norm_freq, period=350*1e-9*1e12)
    df_sample["频率 (Hz)"] = df_sample["频率 (Hz)"].apply(norm_freq, period=350*1e-9)
    ...
    from projects.NearFieldVortex.plot_thickband import main
