...
plt.plot(d0["buffer"]/period, (d2["freq_real"].values-d0["freq_real"].values)/(d1["freq_real"].values-d0["freq_real"].values),
         marker="o", color="orange")
plt.plot(d0["buffer"]/period, np.abs(d2["k"].values-d0["k"].values)/np.abs(d1["k"].values-d0["k"].values),
