...
if __name__ == '__main__':
    # data_path = 'data/FP_PhC_Rect-diff_FP-14eigenband-400nmP-0.1k.csv'
    ...
    new_coords, Z_filtered, min_lens = advanced_filter_eigensolution(
        ...
        z_keys=z_keys,
        fixed_params={
            # 'buffer (nm)': 185.5,  # nearest merging
            'buffer (nm)': 180,
            # "sp_polar_show": 1,
        },  # 固定
        filter_conditions={
    ...
    # from projects.MergingBICs.plot_thickband_Rect import main
    from projects.MergingBICs.plot_thickband_Rect_normal import main
