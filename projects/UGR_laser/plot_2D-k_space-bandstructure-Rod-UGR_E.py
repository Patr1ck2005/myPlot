...
#     ###############################################################################################################
    ...
    # plot eigenfreq in the complex plane
    for dataset in datasets:
        eigenfreq_real = dataset['eigenfreq_real']
        qfactor = np.power(10, dataset['qlog'])
        ax.plot(eigenfreq_real, qfactor, 'o-', markersize=1)
    # ax.set_xlabel('Re(eigenfreq) (THz)')
    ...
    # )
    # plotter.plot(
    #     index=4, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='qlog', cmap='hot_r',
    #     enable_dynamic_color=True, global_color_vmin=2, global_color_vmax=4, linewidth_base=2
    # )
    # plotter.plot(
    #     index=5, x_key=X_KEY, z1_key='eigenfreq_real', z2_key='eigenfreq_imag',
    #     enable_fill=True, default_color='gray', alpha_fill=0.3, scale=1
    # )
    # plotter.plot(
    #     index=5, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='qlog', cmap='hot_r',
    #     enable_dynamic_color=True, global_color_vmin=2, global_color_vmax=4, linewidth_base=2
    # )
    # plotter.plot(
    #     index=8, x_key=X_KEY, z1_key='eigenfreq_real', z2_key='eigenfreq_imag',
    #     enable_fill=True, default_color='gray', alpha_fill=0.3, scale=1
    # )
    # plotter.plot(
    #     index=8, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='qlog', cmap='hot_r',
    #     enable_dynamic_color=True, global_color_vmin=2, global_color_vmax=4, linewidth_base=2
    # )
    # plotter.plot(
    #     index=9, x_key=X_KEY, z1_key='eigenfreq_real', z2_key='eigenfreq_imag',
    #     enable_fill=True, default_color='gray', alpha_fill=0.3, scale=1
    # )
    # plotter.plot(
    #     index=9, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='qlog', cmap='hot_r',
    #     enable_dynamic_color=True, global_color_vmin=2, global_color_vmax=4, linewidth_base=2
    # )
    # plotter.plot(
    #     index=3, x_key=X_KEY, z1_key='eigenfreq_real', z2_key='eigenfreq_imag',
    #     enable_fill=True, default_color='gray', alpha_fill=0.3, scale=1
    # )
    # plotter.plot(
    #     index=3, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='qlog', cmap='hot_r',
    #     enable_dynamic_color=True, global_color_vmin=2, global_color_vmax=4, linewidth_base=2
    # )
    # plotter.plot(
    #     index=2, x_key=X_KEY, z1_key='eigenfreq_real', z2_key='eigenfreq_imag',
    #     enable_fill=True, default_color='gray', alpha_fill=0.3, scale=1
    # )
    # plotter.plot(
    #     index=2, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='qlog', cmap='hot_r',
    #     enable_dynamic_color=True, global_color_vmin=2, global_color_vmax=4, linewidth_base=2
    # )
    for i in range(MAX_NUM):
        i = MAX_NUM - i - 1
    ...
    #     i = MAX_NUM - i - 1
    #     plotter.plot(
    #         index=i, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='qlog', cmap='hot_r',
    #         enable_dynamic_color=True, global_color_vmin=2, global_color_vmax=4, linewidth_base=2
    #     )
    for i in range(MAX_NUM):
        i = MAX_NUM - i - 1
