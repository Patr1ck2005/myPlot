...
if __name__ == '__main__':
    ...
    data_path = 'data/PhC-Tri-I-k_space-vary_fill-t_tot(200,150)-ultrahigh_mesh.csv'
    ...
    param_keys = ["k", "t_slab (nm)", "t_tot (nm)", "fill", "tri_factor", "substrate (nm)"]
...
#     ###############################################################################################################
    ...
    plotter.re_initialized_plot()
    plotter.new_2d_fig(figsize=(2,6))
    for i in range(MAX_NUM):
        plotter.plot(
            index=i, x_key=X_KEY, z1_key='eigenfreq_real', z2_key='eigenfreq_imag',
            enable_fill=True, default_color='gray', alpha_fill=0.3, scale=1
