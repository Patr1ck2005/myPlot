...
if __name__ == '__main__':
    data_path = 'data/die_BIC-k_space.csv'
    ...
    config.update(figsize=(1.25, 1.5), tick_direction='in')
    ...
    plotter.plot(index=1, x_key=X_KEY, z1_key='eigenfreq_real', default_line_color='blue', )
    plotter.plot(index=2, x_key=X_KEY, z1_key='eigenfreq_real', default_line_color='blue', )
    ...
    plotter.plot(index=1, x_key=X_KEY, z1_key='qlog', default_line_color='blue', )
    plotter.plot(index=2, x_key=X_KEY, z1_key='qlog', default_line_color='blue', )
