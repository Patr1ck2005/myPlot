...
if __name__ == '__main__':
    data_path = 'data/plas_BIC-k_space.csv'
    ...
    plotter.plot(index=0, x_key=X_KEY, z1_key='eigenfreq_real', default_line_color='goldenrod', )
    ...
    plotter.plot(index=3, x_key=X_KEY, z1_key='eigenfreq_real', default_line_color='goldenrod', )
    # plot light cone
