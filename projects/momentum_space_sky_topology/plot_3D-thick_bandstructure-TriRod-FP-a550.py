...
if __name__ == '__main__':
    ...
    from polar_postprocess import complete_C2_polarization, geom_complete

    pkl_path = 'rsl/eigensolution/polar_fields.pkl'
    Z_target_complex = Z_target5
    m1, m2 = new_coords['m1'], new_coords['m2']

    m1f, m2f, phi_f, chi_f = complete_C2_polarization(m1, m2, target_phi, target_tanchi)
    (_, _), Z_f = geom_complete({'m1':m1, 'm2':m2}, Z_target5, mode='C4')
