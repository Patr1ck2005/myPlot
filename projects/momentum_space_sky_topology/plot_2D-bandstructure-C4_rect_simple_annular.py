...
if __name__ == '__main__':
    # data_path = 'data/Rect-disk-SiSiO2-diff_geo.csv'
    # data_path = 'data/Rect-simple_Annular-SiSiO2-flat1.csv'
    # data_path = 'data/Rect-simple_Annular-SiSiO2-flat2.csv'
    # data_path = 'data/Rect-simple_Annular-SiSiO2-geo3.csv'
    ...
    # 指定用于构造网格的参数以及目标数据列
    param_keys = ["k", "t_tot (nm)", "P (nm)", "r1 (nm)", "r2 (nm)", "pattern_n"]
