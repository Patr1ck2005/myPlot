...
if __name__ == '__main__':
    data_path = 'data/Hex-triHole-full.csv'
    ...
    _, dataset1 = package_stad_C6_data(new_coords, 0, Z_target1, additional_Z_grouped, z_keys)
    _, dataset2 = package_stad_C6_data(new_coords, 1, Z_target2, additional_Z_grouped, z_keys)
    _, dataset3 = package_stad_C6_data(new_coords, 2, Z_target3, additional_Z_grouped, z_keys)
    _, dataset4 = package_stad_C6_data(new_coords, 3, Z_target4, additional_Z_grouped, z_keys)
    _, dataset5 = package_stad_C6_data(new_coords, 4, Z_target5, additional_Z_grouped, z_keys)
    _, dataset6 = package_stad_C6_data(new_coords, 5, Z_target6, additional_Z_grouped, z_keys)
    _, dataset7 = package_stad_C6_data(new_coords, 6, Z_target7, additional_Z_grouped, z_keys)
    ...
    # plotter.plot_skyrmion_analysis(index=0)
    # plotter.plot_skyrmion_analysis(index=1)
    # plotter.plot_skyrmion_analysis(index=2)
    # plotter.plot_skyrmion_analysis(index=3)
    plotter.plot_skyrmion_analysis(index=4)
    # plotter.plot_skyrmion_analysis(index=5)  # full cover
    # plotter.plot_skyrmion_analysis(index=6)
    # plotter.plot_skyrmion_analysis(index=7)
    # plotter.plot_skyrmion_analysis(index=8)

    plotter.new_3d_fig()
    # plotter.plot_3D_surface(index=0)
    plotter.plot_3D_surface(index=4)
    plotter.plot_3D_surface(index=5)
    # plotter.plot_3D_surface(index=0)
