...
if __name__ == '__main__':
    data_path = 'data/monoclinic_x_space-t_ridge_space-vary_fill.csv'
    ...
    z_keys = ["特征频率 (THz)", "品质因子 (1)", "fake_factor (1)", "up_S3 (1)", "down_S3 (1)", "U_factor (1)"]
...
#     ###############################################################################################################
    ...
    for i, Z_target in enumerate(Z_targets):
        ...
        eigenfreq, qfactor, fake_factor, up_s3, down_s3, u_factor = extract_adjacent_fields(
        ...
        dataset['down_s3'] = down_s3.real.ravel()
        dataset['fom'] = up_s3.real.ravel() * np.abs(np.log(np.abs(u_factor.real.ravel())))
    ...
    for i in range(MAX_NUM):
        plotter.plot(
            index=i, x_key=X_KEY, z1_key='-u_factor', z3_key='up_s3', cmap='coolwarm',
    ...
    for i in range(15):
        plotter.plot(
            index=i, x_key=X_KEY, z1_key='fom', z3_key='up_s3', cmap='coolwarm',
            # enable_dynamic_color=True, global_color_vmin=-1, global_color_vmax=1, linewidth_base=2
        )
    plotter.adjust_view_2dim_auto()
    plotter.add_annotations()
    ...
    for i in range(15):
        plotter.plot(
            index=i, x_key=X_KEY, z1_key='eigenfreq_real', z3_key='up_s3', cmap='coolwarm',
            # enable_dynamic_color=True, global_color_vmin=-1, global_color_vmax=1, linewidth_base=2
        )
    plotter.adjust_view_2dim_auto()
    plotter.add_annotations()
    ...
    for i in range(15):
        plotter.plot(
            index=i, x_key=X_KEY, z1_key='qlog', z3_key='up_s3', cmap='coolwarm',
            # enable_dynamic_color=True, global_color_vmin=-1, global_color_vmax=1, linewidth_base=2
        )
    plotter.adjust_view_2dim_auto()
    plotter.add_annotations()
    ...
    for i in range(15):
        plotter.plot(
            index=i, x_key=X_KEY, z1_key='up_s3', z3_key='up_s3', cmap='coolwarm',
            # enable_dynamic_color=True, global_color_vmin=-1, global_color_vmax=1, linewidth_base=2
        )
    plotter.adjust_view_2dim_auto()
    plotter.add_annotations()
    ...
    for i in range(15):
        plotter.plot(
            index=i, x_key=X_KEY, z1_key='down_s3', z3_key='up_s3', cmap='coolwarm',
            # enable_dynamic_color=True, global_color_vmin=-1, global_color_vmax=1, linewidth_base=2
        )
    plotter.adjust_view_2dim_auto()
    plotter.add_annotations()
